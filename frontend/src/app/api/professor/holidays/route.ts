/**
 * GET /api/professor/holidays?start=YYYY-MM-DD&end=YYYY-MM-DD
 * Lista feriados no intervalo (somente leitura, para o calendário do professor).
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[api/professor/holidays GET]', error)
    return NextResponse.json(
