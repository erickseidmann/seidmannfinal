/**
 * GET /api/admin/chat/conversations/[id]/messages – lista mensagens (paginação: limit, before)
 * POST /api/admin/chat/conversations/[id]/messages – envia mensagem
 */
...
export async function GET(
  ...
  try {
    ...
    // Admin pode ver mensagens de qualquer conversa (modo "ver todas"); envio exige isParticipant
    ...
    console.error('[api/admin/chat/conversations/[id]/messages GET]', error)
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.error('[api/admin/chat/conversations/[id]/messages POST]', error)
    return NextResponse.json(
...
/** Marca a conversa como lida (atualiza lastReadAt) */
export async function PATCH(
  ...
  try {
    ...
    console.error('[api/admin/chat/conversations/[id]/messages PATCH]', error)
    return NextResponse.json(
