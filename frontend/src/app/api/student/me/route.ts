    ...
    return NextResponse.json({
      ...
      data: {
        aluno: {
          ...
          emailResponsavel: (enrollment as { emailResponsavel?: string | null }).emailResponsavel ?? null,
    ...
    return NextResponse.json({
      ...
      data: {
        aluno: {
          ...
          emailResponsavel: (updated as { emailResponsavel?: string | null }).emailResponsavel ?? null,
