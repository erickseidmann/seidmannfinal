/**
 * Dashboard Professores – Alterar senha (obrigatório no primeiro acesso)
 */
...
export default function AlterarSenhaPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true)
    try {
      const res = await fetch('/api/professor/alterar-senha', {
        method: 'POST',
    ...
    <main className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-md mx-auto px-4 py-4">
          <h1 className="text-xl font-bold text-gray-900">Dashboard Professores – Alterar senha</h1>
        </div>
      </header>
