...
fse_schedules\ (
    ...
    \aturamento_tipo\ VARCHAR(20) NOT NULL,
    ...
    \epeat_monthly\ BOOLEAN NOT NULL DEFAULT false,
    \created_at\ DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    \updated_at\ DATETIME(3) NOT NULL,
    UNIQUE INDEX \
fse_schedules_enrollment_id_year_month_key\(\enrollment_id\, \year\, \month\),
    INDEX \
fse_schedules_scheduled_for_idx\(\scheduled_for\),
    PRIMARY KEY (\id\)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

ALTER TABLE \
fse_schedules\ ADD CONSTRAINT \
fse_schedules_enrollment_id_fkey\ FOREIGN KEY (\enrollment_id\) REFERENCES \enrollments\(\id\) ON DELETE CASCADE ON UPDATE CASCADE;
